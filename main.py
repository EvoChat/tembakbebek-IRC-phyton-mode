#! /usr/bin/python3
# Tembak bebek versi phyton irc.evochat.id 2025
# Modified.......:buayadarat
# Contributors...: End3r, f, bildramer liberachat from tcl duckhunt to phyton
# IMPORT # =============================================================================================================
...
# MAIN LOOP STUFF
# ======================================================================================================================
print(f'tembak bebek {botversion} by evochat starting up!')
# ======================================================================================================================
# Connect to server
# ======================================================================================================================
irc = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
...
# ======================================================================================================================
                    ...
                    if data[3].lower() == b':!help' or data[3].lower() == b':!about' or data[3].lower() == b':!commands' or data3.lower() == b'!help':
                        irc.send(b'PRIVMSG ' + duckchan + b' :For HELP: https://evochat.id')
                        continue
                    # ======================================================================================================================
